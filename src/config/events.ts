...
export const UniBandEvents: Event[] = [
...

    {
      ...
      description:
        "The 2025 Semester 2 concert, performed by UniBand, Jazz Band and the Wind Ensemble. Directed by Jono Palmer with guest conductors Sue Lynn Leong and Athena Shui. Tickets can  be purchased from Eventbrite here:https://www.eventbrite.co.nz/e/land-city-sea-tickets-1666109290739?aff=oddtdtcreator ",
